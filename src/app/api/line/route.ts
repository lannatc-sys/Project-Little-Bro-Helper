    ...
    for (const event of events) {
      if (event.type === "message" && event.message.type === "text") {
        ...
        if (numberMatches && gasUrl && ssId) {
          ...
          replyMessage = `สวัสดีครับ ผมคือ Little Bro Assistant 👔 ยินดีที่ได้บริการทาง LINE OA ครับ\n\nบอสสามารถสั่งงานผมได้ดังนี้:\n1. พิมพ์จดบันทึกรายรับ-รายจ่าย เช่น "ค่าข้าว 120" หรือ "รายได้ 5000"\n2. เปิดดูข้อมูลแดชบอร์ดการเงินและตารางงานที่เชื่อมโยงกับระบบชีตได้ตลอดเวลาครับ`;
        }

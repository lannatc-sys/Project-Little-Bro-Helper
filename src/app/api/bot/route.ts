...
export async function POST(request: Request) {
  ...
  try {
    ...
    if (text.startsWith("/start")) {
      ...
      replyText = `สวัสดีครับพี่ ${username}! เริ่มต้นใช้งานน้องชายผู้ช่วยส่วนตัว Little Bro Assistant เรียบร้อยแล้วนะพี่ 📲\nน้องพร้อมช่วยพี่จดบันทึกการเงินและเตือนความจำกิจกรรมต่างๆ แล้วครับผม\n\nพิมพ์คุยเพื่อจดบัญชีกับน้อง หรือกดปุ่มเปิดแอปด้านล่างได้เลยนะพี่`;
      inlineKeyboard = [
        [
          {
      ...
      if (numberMatches) {
        ...
        replyText = `สวัสดีครับพี่! ผมคือน้องชาย Little Bro 👔 ผู้ช่วยแสนดีคนเดิมของพี่เอง\n\nพี่สามารถสั่งงานหรือจดบันทึกผ่านน้องได้ง่ายๆ เลยนะพี่:\n\n1. *จดบัญชีด่วน*: พิมพ์รายการเงิน เช่น "ค่าข้าว 150" หรือ "รายรับ 4500" บอกน้องได้ทันที!\n2. *เรียกใช้คำสั่งระบบ*:\n   /home - เปิดแดชบอร์ดหลัก\n   /money - หน้าจอรับ-จ่าย\n   /task - ดูรายการสิ่งที่ต้องทำ`;
        inlineKeyboard = [
          [
            {
